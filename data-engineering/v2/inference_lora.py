...
LORA_CHECKPOINT_PATH = "./lora-train/checkpoint-43120" 
...
def correct_grammar(model, tokenizer, text):
    prefix = "korrigiere: " # MUST match what you used during training
    inputs = tokenizer(
        prefix + text, 
        return_tensors="pt", 
        max_length=128, 
...
if __name__ == "__main__":
    ...
    model.save_pretrained("./models/inference_lora_model")
    tokenizer.save_pretrained("./models/inference_lora_model")